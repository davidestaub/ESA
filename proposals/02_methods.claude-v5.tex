...
leaving 102 event-complement integrations from which the fixed
calibration masks of the truth-blind calibrations are selected
(Appendix~\ref{app:nova}). The full construction, delivery manifest, and
