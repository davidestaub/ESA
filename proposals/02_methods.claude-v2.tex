...
Appendix~\ref{app:nova}. The two deterministic starts share no state: one
begins at the white-light mean depth recorded in the release
configuration, with zero morphology and theory limb darkening, the other adds a fixed zero-mean 250 ppm morphology
perturbation and small fixed limb-darkening offsets. Both starts of the
