...
the fitted quantities, the transmission spectrum, the limb darkening, the
continuum, and the background, from the observed samples, conditional on
the fixed response, orbit, and source-curvature factor. Nothing is extracted, binned,
