...
repair of the known spatial-response defect. The correction will use a single
flux-conserving rule across all columns, be calibrated on alternating
out-of-transit folds, and be selected by held-out detector likelihood. It must
not degrade the other order or the aggregate recovery, and it will be fixed
before comparison with a new hidden spectrum.
